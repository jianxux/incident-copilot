...
class APIKey(BaseModel):
    ...
    @classmethod
    def generate(cls, tenant_id: str, created_by: str, name: str, scopes: list[str] = None) -> tuple["APIKey", str]:
...
class Session(BaseModel):
    ...
    refresh_expires_at: datetime = Field(default_factory=lambda: datetime.utcnow() + timedelta(days=30))
...
PLAN_LIMITS = {
    ...
    PlanTier.STARTER: {
        ...
        "max_users": 10,
        "max_integrations": 5,
        "features": ["basic_context", "slack_delivery", "ai_summaries", "past_incidents"],
    },
    PlanTier.PRO: {
        "max_incidents_per_month": 2000,
        "max_users": 50,
        "max_integrations": 10,
        "features": ["basic_context", "slack_delivery", "ai_summaries", "past_incidents", "runbook_linking", "analytics"],
    },
    PlanTier.ENTERPRISE: {
