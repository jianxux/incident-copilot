...
# Application info
APP_INFO = Info("incident_copilot", "Incident Copilot application information")
...
WEBHOOK_REQUESTS_TOTAL = Counter(
    ...
    [
        "source",
        "status",
    ],  # source: pagerduty, opsgenie; status: success, error, invalid
)
...
ACTIVE_CONNECTIONS = Gauge(
    "incident_copilot_active_connections", "Number of active HTTP connections"
)
