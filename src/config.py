...
class Settings(BaseSettings):
    ...
    teams_app_id: str = Field(
        default="", description="Teams Bot Framework app/client ID"
    )
    teams_app_password: str = Field(
        default="", description="Teams Bot Framework app password/secret"
    )
    teams_bot_id: str = Field(
        default="", description="Teams bot user ID (to ignore own messages)"
    )
